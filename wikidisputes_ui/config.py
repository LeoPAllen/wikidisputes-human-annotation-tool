"""Project configuration loading and phase gating."""
...
class ProjectConfig:
    ...
    def active_sheet(self) -> str:
        return {"calibration": "3_Calibration_Coder", "heldout": "4_Heldout_Coder"}[self.phase]
...
def load_config(path: str | Path = "config/project.toml") -> ProjectConfig:
    ...
    if phase == "heldout" and not values["schema_locked"]:
        raise ValueError("heldout phase requires schema_locked = true")
